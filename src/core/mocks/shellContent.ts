...
export const homeHighlights = [
  '基于现代前端工程搭建，具备清晰路由与应用壳层',
  '应用壳层状态已为路由感知界面元数据预留',
  '核心目录已按契约、模拟数据、规则、代理、事件与持久化分层',
];

export const homeRoadmap = [
  '把契约转成运行时校验，并验证首个模拟世界包',
  '补齐世界、区域、任务、角色与存档元数据的状态切片',
  '实现启动加载/回退流程，以及首个可玩的角色任务切片',
];
...
export const gamePanels: Record<'map' | 'npc' | 'quest' | 'combat', FeaturePanel> = {
  ...
  npc: {
    ...
    status: 'planned',
    points: ['对话面板骨架', '角色元数据摘要', '信任与关系指示器'],
    footer: '角色决策将通过经过校验的代理输出与规则层流转。',
  },
  quest: {
    title: '任务追踪',
  ...
  combat: {
    title: '战斗与战术',
    description: '为第三阶段的首领战和战术回顾预留入口。',
    status: 'planned',
    points: ['遭遇战摘要', '敌方战术轨道', '战斗日志区域'],
    footer: '自适应战术和阶段变化应由规则层与模拟代理共同负责。',
  },
};
...
export const debugPanels: FeaturePanel[] = [
  {
    title: '状态检查器',
    description: '为世界、任务、角色、战斗与存档切片检查预留的面板。',
    status: 'planned',
    points: ['世界查看器', '任务查看器', '角色查看器'],
    footer: '常用测试场景应能在 30 秒内从这里进入。',
  },
  {
    title: '场景装载器',
    description: '未来用于加载确定性模拟世界、存档和战斗预设的入口。',
    status: 'planned',
